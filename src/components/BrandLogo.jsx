...
export default function BrandLogo({ tagline = "Del campo a tu negocio, sin intermediarios" }) {
  return (
    <header className="text-center">
      ...
      <p className="mt-2 text-xs font-bold uppercase tracking-wider text-green-700">{tagline}</p>
    </header>
  );
}
